...
import logging
import os
log_dir = '/home/hit/ypr_e2e/PlanKD_o/results/logs'
...
from interfuser.plankd_mem import PlanKD
...
parser.add_argument("--beta_wp", type=float, default=5, help="hyper-parameter of wp")
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        with amp_autocast():
            ...
            if args.use_kd:
                ...
                loss += args.beta_wp * loss_wp_g
                loss = loss + 0.1*output_kd[6]+0.1*output_kd[7]+0.1*output_kd[8]
